...
LOG_GROUP = int(os.getenv("LOG_GROUP", "-1002610898117")) # optional with -100
FORCE_SUB = int(os.getenv("FORCE_SUB", "-1002610898117")) # optional with -100
...
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/+tUmzY6n970Q5ZGVl")
